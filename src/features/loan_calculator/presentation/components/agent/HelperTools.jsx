...
import { calculateMaxPropertyPriceFromBudget } from "../../../../../utils/financialEngine.js";
import {
  formatCurrency,
  formatPercent,
...
function HelperTools() {
  ...
  const [selectedPersonaId, setSelectedPersonaId] =
    React.useState(personaOptions[0]?.value || "");
      ...
      >
        <div className="space-y-4">
          ...
          <p className="text-[11px] text-slate-400">
            Use this when client says “I can do RM{" "}
            {monthlyBudget.toFixed(0)} a month” but has no idea what
            property price range that supports.
          </p>
        </div>
      </Card>
    </div>
