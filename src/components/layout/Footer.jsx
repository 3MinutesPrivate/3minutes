 ...
 * 法务与 PDPA 文案：
 * - 文案内容不可删减或通过配置修改
 * - 视觉上尽量低调：小字号、浅颜色，避免占据过多视觉焦点
 */
function Footer() {
  return (
    <footer className="mt-8 border-t border-slate-800/80 bg-slate-950/95">
      <div className="mx-auto max-w-6xl px-4 py-3 space-y-2">
        <div className="flex flex-wrap items-start justify-between gap-4 text-[11px] text-slate-400">
          ...
          <div className="max-w-md space-y-1 text-[10px] text-slate-500 leading-snug">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4 pt-2 border-t border-slate-800/80 text-[10px] leading-snug">
